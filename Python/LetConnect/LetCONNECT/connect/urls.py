...
#     path("n/follwing", views.following, name = 'following'),
#     path('n/saved', views.saved, name = "saved"),
#     path('n/createpost', views.create_post, name = "createpost"),
#     path('n/post/<int:id>/like', views.like, name = "saved"),
#     path('n/post/<int:id>/unlike', views.unilike_post, name = "unlike"),
#     path('n/post/<int:id/save', views.save_post, name = "savepost"),
#     path('n/post/<int:id>/unsave', views.unsave_post, name = "unsavepost"),
#     path('n/post/<int:id>/comments', views.comment, name = "comments"),
#     path('n/post/<int:id>/write_comment', views.comment, name = "writecomment"),
#     path('n/saved/<int:id>/delete', views.delete_post, name = "deletepost"),
