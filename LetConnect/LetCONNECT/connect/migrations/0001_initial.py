    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creater', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='connect.user')),
                ('likers', models.ManyToManyField(blank=True, related_name='likes', to='connect.user')),
                ('savers', models.ManyToManyField(blank=True, related_name='saved', to='connect.user')),
            ],
        ),
        migrations.CreateModel(
            name='Follower',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('followers', models.ManyToManyField(blank=True, related_name='following', to='connect.user')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followers', to='connect.user')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('commenter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commenters', to='connect.user')),
            ],
        ),
    ]
