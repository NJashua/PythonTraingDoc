...
#         password = request.POST['password']
#         pass_confirmation = request.POST['pass_confirmation']
#         if password != pass_confirmation:
#             return render(request, "connect/register.html", {
#                 "message": "Password mis-match broh..:)"
#             })
...
#             return render(request, "connect/register.html", {
#                 "message": "User name already exists broh..:)"
#             })
...
#     all_posts = Post.objects.filter(creater = user).order_by('-data_created')
#     paginator = Paginator(all_posts, 10)
#     page_number = request.GET.get('page')
#     if page_number == None:
#         page_number = 1
#         posts = page_number.get_page(page_number)
#         following = []
#         suggestions = []
#         follower = False
#         if request.user.is_authenticated:
...
#         follower_count = Follower.objects.get(user = user).follower.all().count()
...
#         all_posts = Post.objects.filter(creater_in = following_user).order_by('-date_created')
#         paginator = Paginator(all_posts, 10)
#         page_number = request.GET.get('page')
#         if page_number == None:
#             page_number = 1
...
# def saved(request):
#     if request.user.is_authenticated:
#         all_posts = Post.objects.filter(save = request.user)
#         Paginator = Paginator(all_posts, 10)
#         page_number = request.GET.get('page')
#         if page_number == None:
#             page_number = 1
...
#     else:
#         return HttpResponse("Method must be 'POST' broh..:)" )
...
#                 return HttpResponse(msg)
#         else:
#             return HttpResponse("Method must be 'PUT' broh..:)")
#     else:
#         return HttpResponseRedirect(reverse('login'))

# @csrf_exempt
# def unilike_post(request, id):
#     if request.user.is_authenticated:
#         if request.method == 'PUT':
#             post = Post.objects.get(pk=id)
#             try:
...
#                 return HttpResponse(msg)
#         else:
#             return HttpResponse("Method must be 'POST' bro..:")            
#     else:
#         return HttpResponseRedirect(reverse('login'))
